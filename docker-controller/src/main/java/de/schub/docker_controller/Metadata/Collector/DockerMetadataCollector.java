...
import de.schub.docker_controller.DockerController;
...
public class DockerMetadataCollector implements MetadataCollector
{
    Logger logger = LoggerFactory.getLogger(DockerMetadataCollector.class);
    DockerClient dockerClient;

    protected DockerMetadataCollector()
    {
    }

    @Inject
    public DockerMetadataCollector(URI endpoint) throws MetadataCollectorException
    {
        try {
    ...
    protected URI parseURI(URI endpoint) throws MetadataCollectorException
    {
        ...
        try {
            ...
            throw new MetadataCollectorException("unable to build endpoint url", e);
        }
    }
